...
st.markdown(
    'Date of Last Update: 04/29/2025<br><br><br>',
...
st.markdown("""
<h1>
    <b>Scope 2, Market Based</b>
    <span title="1. Utility Average Emissions Rate is defined as the average amount of carbon dioxide emissions associated with the electricity delivered to customers.&#10;2. EEI Utility Emission Factors (EFs) are provided for CO2 only.&#10;Use Location-Based CH4 and N2O factors to calculate total CO2e for dual reporting." style="font-size: 0.4em; vertical-align: top; cursor: help;">ℹ️</span>
</h1>
""", unsafe_allow_html=True)
